...
namespace ZHDev.Extensions
{
    public static class CameraExtensions
    {
        ...
        public static bool GetScreenPointIntersectionWithPlane(this Camera camera, Vector2 screenPoint,
            Vector3 planeNormal, Vector3 planePoint, out Vector3 intersectionPoint)
        {
            Plane targetPlane = new Plane(planeNormal, planePoint);
            Ray screenPointRay =
                camera.ScreenPointToRay(new Vector3(screenPoint.x, screenPoint.y, camera.nearClipPlane));
